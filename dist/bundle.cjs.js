...
var ModalProvider = function ModalProvider(_ref) {
  ...
  var openModal = function openModal(modal, props) {
    ...
    setModals([].concat(_toConsumableArray(modals), [newModal]));
    return id;
  };

  var closeModal = function closeModal(id) {
    setModals(modals.filter(function (m) {
      return m.id !== id;
    }));
  };
...
var RootContext = React.createContext({
  transitionState: '',
  zIndex: 5000,
...
var RemoveScroll = styledComponents.createGlobalStyle(_templateObject());
...
function Root() {
  ...
  return React__default.createElement(React__default.Fragment, null, modals.length > 0 && React__default.createElement(RemoveScroll, null), React__default.createElement(TransitionGroup, {
    component: null
  }, React.useMemo(function () {
    return modals.map(function (_ref, index) {
      var id = _ref.id,
...
function useModal(modal) {
  ...
  return [function (props) {
    return setModalId(openModal(modal, props));
  }, function () {
...
exports.ModalRoot = Root;
exports.ModalRootContext = RootContext;
